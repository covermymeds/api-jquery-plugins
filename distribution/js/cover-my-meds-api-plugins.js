...
__p+='<tr><td><h4>No Results</h4></td></tr>';
 } 
__p+='';
 _(requests).each(function (request) { 
__p+='<tr><td class="form-thumbnail"><a href="'+
((__t=( request.tokens[0].html_url ))==null?'':__t)+
'" target="_blank">';
 if (request.form_id) { 
__p+='<img src="https://www.covermymeds.com/forms/pdf/thumbs/90/highmark_west_virginia_prescription_drug_medication_6827.jpg"> ';
 } else { 
__p+=' <img src="https://www.covermymeds.com/styles_r2/images/pick_the_form.png" alt="Pick the form"> ';
 } 
__p+='</a></td><td><h4>'+
((__t=( request.patient.first_name + ' ' + request.patient.last_name ))==null?'':__t)+
'(Key: '+
((__t=( request.id ))==null?'':__t)+
')</h4><dl class="dl-horizontal request-details"><dt>Status</dt><dd><span class="label label-info">'+
((__t=( request.workflow_status ))==null?'':__t)+
'</span></dd><dt>Drug</dt><dd>'+
...
__p+='</dd><dt></dt><dd><a href="'+
((__t=( request.tokens[0].html_url ))==null?'':__t)+
'" target="_blank">'+
((__t=( window.NEWCROP ? "Complete " : "View " ))==null?'':__t)+
'this request &rarr;</a></dd></dl></td></tr>';
 }); 
__p+='</table>';
 if (totalPages > 0) { 
__p+='<ul class="pagination">';
 i = 0; 
__p+='<li class="'+
((__t=( active(i, currentPage) ))==null?'':__t)+
'"><a href="#" data-page="'+
((__t=( i ))==null?'':__t)+
'">'+
((__t=( (i + 1) ))==null?'':__t)+
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row"><div class="navigation col-md-3"><ul class="order nav nav-pills"><li class="active"><a href="#" data-order="newest">Newest First</a></li><li><a href="#" data-order="oldest">Oldest First</a></li></ul><hr><ul class="folders nav nav-pills nav-stacked">';
 _(folders).each(function (folder, name) { 
__p+='<li class="'+
((__t=( active(name, currentFolder) ))==null?'':__t)+
'"><a href="#" data-folder-name="'+
((__t=( name ))==null?'':__t)+
'"><span class="glyphicon glyphicon-folder-close"></span> '+
((__t=( name ))==null?'':__t)+
' <span class="badge pull-right" id="folder-'+
((__t=( name.toLowerCase() ))==null?'':__t)+
'-count">0</span></a></li>';
 }); 
__p+='</ul><hr><form action="#" class="well" method="get" role="form"><fieldset><legend>Search</legend><div class="input-group"><input class="form-control search" name="q" placeholder="Search" type="search"><span class="input-group-btn"><button class="clear btn btn-default" type="button"><span class="clear glyphicon glyphicon-remove"></span></button></span></div></fieldset></form></div><div class="content col-md-9"></div></div>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<table class="table"><tr><td><img src="'+
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<h1>For assistance using CoverMyMeds&reg;</h1><ul><li>Phone: 1-866-452-5017</li><li>Email: <a href="mailto:help@covermymeds.com">help@covermymeds.com</a></li></ul><h1>Send forms or report data issues</h1><ul><li>Phone: 1-866-452-5017</li><li>Fax: 1-615-379-2541</li><li>Email: <a href="mailto:data@covermymeds.com">data@covermymeds.com</a></li></ul>';
}
return __p;
};
...
},{"../templates/dashboard-content.html":2,"../templates/dashboard.html":3,"../vendor/base64.js":6,"underscore":14}],9:[function(require,module,exports){
(function (global){
/*jslint sloppy: true, unparam: true, todo: true */
...
},{"../vendor/base64.js":6,"select2-browserify":12}],10:[function(require,module,exports){
(function (global){
...
},{"../templates/form-search.html":4,"../vendor/base64.js":6,"select2-browserify":12}],11:[function(require,module,exports){
(function (global){
/*jslint sloppy: true */
...
},{"../select2/select2.js":13}],13:[function(require,module,exports){
/*
